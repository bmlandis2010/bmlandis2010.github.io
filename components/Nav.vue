<template>
        ...
        <li><NuxtLink to="/order-of-service"><span class="icon">
          ...
          </span><span class="menu"><span>Memorial </span>Service</span></NuxtLink></li>
        ...
        <li><NuxtLink to="/gallery"><span class="icon">
          ...
          </span><span class="menu">Photo Album</span></NuxtLink></li>
        <li><NuxtLink to="/charity-donation"><span class="icon">
          ...
          </span><span class="menu"><span>Suggested </span>Donations</span></NuxtLink></li>
      </ul>
